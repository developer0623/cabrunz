...
import com.cabrunzltd.user.component.MyFontHistoryTextView;
...
//	 */
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case TYPE_ITEM:
				...
				holder.ivIcon = (CircularImageView) convertView
						.findViewById(R.id.ivHistoryIcon);
				holder.tvtype =  (MyTitleFontTextView) convertView
						.findViewById(R.id.tvHistorytype);
	...
	private class ViewHolder {
		...
		MyTitleFontTextView tvCost, tvDate, tvtype;
